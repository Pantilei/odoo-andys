odoo.define('restaurant_management.many2many_binary_preview_widget', function (require) {
    "use strict";

var AbstractField = require('web.AbstractField');
var core = require('web.core');
var registry = require('web.field_registry');
var DocumentViewer = require('restaurant_management.legacy.DocumentViewer');
 ...
 */
var FieldMany2ManyBinaryPreview = AbstractField.extend({
    ...
    _render: function () {
        ...
        console.log("this.template_files", this.template_files);
        // let src = '/web/content/' + $img.closest(".o_image_box").data("id");
        //         console.log("SRC", src);
